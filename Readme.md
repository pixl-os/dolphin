# Dolphin - A GameCube, Triforce and Wii Emulator (Thanks Crediar for this triforce version !)
...
Sorry, we didn't fork Crediar's one due to private repo :-(
We did this branch in our fork of dolphin-emu especially to have a version that we could build for pixL
